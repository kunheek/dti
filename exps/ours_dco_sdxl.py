...
def main():
    ...
    for name, metadata in data.items():
        ...
        cmd = [
            ...
            "--peft_rank=4",
            "--peft_start_step=1",
            f"--peft_learning_rate={args.lora_lr}",
            "--dcoloss_beta=1000",
        ]

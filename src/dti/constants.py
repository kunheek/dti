...
DIFFUSERS_MODELS = {
    ...
    "flux2klein_base_4b": "black-forest-labs/FLUX.2-klein-base-4B",
    "flux2klein_4b": "black-forest-labs/FLUX.2-klein-4B",
    "wan2.1_t2v_1.3b": "Wan-AI/Wan2.1-T2V-1.3B-Diffusers",
